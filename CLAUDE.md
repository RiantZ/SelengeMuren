...
- Follow [Conventional Commits](https://www.conventionalcommits.org): `<type>(<scope>): <description>`. See `doc/commit_conventions.md`.
- **Never** include AI attribution in commit messages — no `Made-with:`, `Co-Authored-By:`, `Generated by`, or any other trailer/tag referencing AI agents or tools.
